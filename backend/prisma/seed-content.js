...
const items = [
  // ===== Weapons (STR/INT) =====
  { name: "Espada de Iniciante", description: "Uma espada simples forjada para novos aventureiros.", type: "weapon", subtype: "sword", rarity: "common", level: 1, rank: 1, buyPrice: 50, sellPrice: 10, strength: 4, dexterity: 1, attackSpeedMs: 2000, dps: 8, icon: "/weaponicon/sword.png" },
  { name: "Adaga de Iniciante", description: "Leve e afiada, ideal para golpes precisos.", type: "weapon", subtype: "dagger", rarity: "common", level: 1, rank: 1, buyPrice: 50, sellPrice: 10, strength: 2, dexterity: 3, attackSpeedMs: 1500, dps: 7, icon: "/daggericon/dagger.png" },
  { name: "Cajado do Aprendiz", description: "Canaliza os primeiros feitiços de um mago.", type: "weapon", subtype: "staff", rarity: "common", level: 1, rank: 1, buyPrice: 50, sellPrice: 10, intellect: 5, attackSpeedMs: 2400, dps: 8, icon: "/weaponicon/staff.png" },
  { name: "Cajado da Luz", description: "Um cajado abençoado que fortalece as curas.", type: "weapon", subtype: "staff", rarity: "common", level: 1, rank: 1, buyPrice: 50, sellPrice: 10, intellect: 4, wisdom: 1, attackSpeedMs: 2400, dps: 7, icon: "/weaponicon/staff.png" },
  { name: "Espada de Ferro", description: "Uma espada de ferro confiável para aventureiros iniciantes.", type: "weapon", subtype: "sword", rarity: "uncommon", level: 3, rank: 2, buyPrice: 150, sellPrice: 30, strength: 8, dexterity: 2, attackSpeedMs: 2000, dps: 15, icon: "/weaponicon/sword.png" },
  { name: "Adaga Serrilhada", description: "Lâmina serrilhada que causa ferimentos graves.", type: "weapon", subtype: "dagger", rarity: "uncommon", level: 3, rank: 2, buyPrice: 140, sellPrice: 28, strength: 4, dexterity: 6, attackSpeedMs: 1500, dps: 13, icon: "/daggericon/dagger.png" },
  { name: "Cajado Arcano", description: "Canaliza poder arcano com precisão.", type: "weapon", subtype: "staff", rarity: "uncommon", level: 3, rank: 2, buyPrice: 160, sellPrice: 32, intellect: 10, wisdom: 2, attackSpeedMs: 2400, dps: 15, icon: "/weaponicon/staff.png" },
  { name: "Machado de Batalha", description: "Uma lâmina pesada que parte escudos.", type: "weapon", subtype: "axe", rarity: "rare", level: 6, rank: 3, buyPrice: 400, sellPrice: 80, strength: 18, endurance: 3, attackSpeedMs: 2600, dps: 30, icon: "/weaponicon/axe.png" },
  { name: "Grimório Antigo", description: "Um tomo arcano repleto de feitiços esquecidos.", type: "weapon", rarity: "rare", level: 6, rank: 3, buyPrice: 420, sellPrice: 84, intellect: 16, wisdom: 5, attackSpeedMs: 2600, dps: 28, icon: "/weaponicon/staff.png" },
  // ===== Helms (END/WIS) =====
  { name: "Capuz de Pano", description: "Proteção simples para a cabeça.", type: "helm", rarity: "common", level: 1, rank: 1, buyPrice: 30, sellPrice: 6, endurance: 2, wisdom: 1, icon: "/helmeticon/helm.png" },
  { name: "Elmo de Ferro", description: "Elmo resistente dos soldados da vila.", type: "helm", rarity: "uncommon", level: 3, rank: 2, buyPrice: 110, sellPrice: 22, endurance: 6, wisdom: 2, icon: "/helmeticon/helm.png" },
  { name: "Coroa Arcano", description: "Coroa encantada que amplifica o conhecimento.", type: "helm", rarity: "rare", level: 6, rank: 3, buyPrice: 360, sellPrice: 72, wisdom: 10, intellect: 5, icon: "/helmeticon/helm.png" },
  // ===== Armors (END/DEX) =====
  { name: "Túnica Simples", description: "Roupas leves e confortáveis.", type: "armor", rarity: "common", level: 1, rank: 1, buyPrice: 40, sellPrice: 8, endurance: 3, icon: "/armoricon/armor.png" },
  { name: "Armadura de Couro", description: "Proteção leve e resistente.", type: "armor", rarity: "uncommon", level: 2, rank: 2, buyPrice: 120, sellPrice: 24, endurance: 8, dexterity: 2, icon: "/armoricon/armor.png" },
  { name: "Cota de Malha", description: "Anéis de aço entrelaçados para máxima defesa.", type: "armor", rarity: "rare", level: 6, rank: 3, buyPrice: 380, sellPrice: 76, endurance: 14, strength: 4, icon: "/armoricon/armor.png" },
  // ===== Capes (WIS/LUK) =====
  { name: "Capa Esfarrapada", description: "Uma capa velha que esconde bem seu dono.", type: "cape", rarity: "common", level: 1, rank: 1, buyPrice: 35, sellPrice: 7, wisdom: 2, luck: 1, icon: "/cloakicon/cape.png" },
  { name: "Manto de Veludo", description: "Um manto elegante dos nobres da vila.", type: "cape", rarity: "uncommon", level: 3, rank: 2, buyPrice: 130, sellPrice: 26, wisdom: 6, luck: 3, icon: "/cloakicon/cape.png" },
  { name: "Capa do Vento", description: "Flutua como o vento e melhora os reflexos.", type: "cape", rarity: "rare", level: 6, rank: 3, buyPrice: 340, sellPrice: 68, dexterity: 8, luck: 4, icon: "/cloakicon/cape.png" },
  // ===== Consumables =====
  { name: "Poção de Vida", description: "Restaura 50 de vida.", type: "consumable", subtype: "potion", rarity: "common", level: 1, isStackable: true, maxStack: 99, buyPrice: 20, sellPrice: 4, effects: '{"heal": 50}', icon: "/potionicon/vida.png" },
  { name: "Poção de Mana", description: "Restaura 40 de mana.", type: "consumable", subtype: "potion", rarity: "common", level: 1, isStackable: true, maxStack: 99, buyPrice: 25, sellPrice: 5, effects: '{"manaRestore": 40}', icon: "/potionicon/mana.png" },
  // ===== Materiais de craft (consumíveis) =====
  { name: "Fragmento do Abismo", description: "Um pedaço de pedra sombria que pulsa com energia do submundo. Usado em receitas de craft.", type: "consumable", subtype: "material", rarity: "epic", level: 5, isStackable: true, maxStack: 99, buyPrice: 100, sellPrice: 25, icon: "/materialicon/crystal.png" },
  { name: "Cristal Sombrio", description: "Cristal negro que absorve luz. Matéria-prima rara de forja abissal.", type: "consumable", subtype: "material", rarity: "rare", level: 5, isStackable: true, maxStack: 99, buyPrice: 80, sellPrice: 20, icon: "/materialicon/crystal.png" },
  { name: "Núcleo Demoníaco", description: "O coração pulsante de um demônio derrotado. Muito valioso.", type: "consumable", subtype: "material", rarity: "legendary", level: 5, isStackable: true, maxStack: 99, buyPrice: 200, sellPrice: 50, icon: "/materialicon/crystal.png" },
  // ===== Itens craftáveis =====
  { name: "Espada do Abismo", description: "Forjada no submundo, essa espada drena a vitalidade dos inimigos. Só pode ser criada pelos mais fortes.", type: "weapon", subtype: "sword", rarity: "epic", level: 10, rank: 4, buyPrice: 0, sellPrice: 1000, strength: 35, dexterity: 15, attackSpeedMs: 2000, dps: 120, icon: "/weaponicon/sword.png" },
  { name: "Manto do Abismo", description: "Um manto costurado com tecido sombrio. Protege quem atravessou a escuridão.", type: "armor", rarity: "epic", level: 10, rank: 4, buyPrice: 0, sellPrice: 800, endurance: 30, wisdom: 12, icon: "/cloakicon/cape.png" },
];
...
// Anéis e Colares são exclusivos do gacha (Boosters) e nunca recebem encantamento.
...
const monsters = [
  ...
  { name: "Rato da Floresta", description: "Um roedor feroz que invade acampamentos.", level: 1, hp: 30, mana: 0, attack: 6, defense: 2, magic: 0, magicDefense: 2, speed: 10, xpReward: 20, classXpReward: 12, goldReward: 8, attackSpeed: 2000, drops: [{ item: "Poção de Vida", chance: 30, min: 1, max: 2 }] },
  { name: "Slime Verde", description: "Gosma gelatinosa comum nas florestas.", level: 1, hp: 25, mana: 0, attack: 5, defense: 3, magic: 0, magicDefense: 2, speed: 5, xpReward: 15, classXpReward: 10, goldReward: 5, attackSpeed: 2500, drops: [{ item: "Poção de Mana", chance: 25, min: 1, max: 1 }, { item: "Capa Esfarrapada", chance: 40, min: 1, max: 2 }] },
  { name: "Lobo Cinzento", description: "Um predador veloz que caça em matilha.", level: 2, hp: 45, mana: 0, attack: 9, defense: 4, magic: 0, magicDefense: 3, speed: 14, xpReward: 35, classXpReward: 24, goldReward: 15, attackSpeed: 1800, skills: JSON.stringify([{ name: "Mordida Feroz", slug: "mordida-feroz", description: "Uma mordida poderosa que causa dano extra.", kind: "attack", trigger: "active", target: "enemy", cooldown: 5000, manaCost: 0, rankRequired: 1, actions: [{ action: "damage", amount: 12, scaling: [{ stat: "attack", factor: 1.2 }], damageType: "physical" }] }]), drops: [{ item: "Poção de Vida", chance: 40, min: 1, max: 2 }, { item: "Espada de Ferro", chance: 8, min: 1, max: 1 }] },
  { name: "Goblin Saqueador", description: "Pequeno, covarde e perigoso com sua adaga.", level: 3, hp: 60, mana: 10, attack: 12, defense: 5, magic: 2, magicDefense: 3, speed: 12, xpReward: 60, classXpReward: 45, goldReward: 25, attackSpeed: 1600, skills: JSON.stringify([{ name: "Adaga Envenenada", slug: "adaga-envenenada", description: "Ataca com uma adaga coberta de veneno corrosivo.", kind: "attack", trigger: "active", target: "enemy", cooldown: 6000, manaCost: 5, rankRequired: 1, actions: [{ action: "damage", amount: 10, scaling: [{ stat: "attack", factor: 1 }], damageType: "physical" }, { action: "applyEffect", effect: "veneno-corrosivo", target: "enemy", stacks: 1 }] }]), drops: [{ item: "Poção de Vida", chance: 30, min: 1, max: 1 }, { item: "Adaga Serrilhada", chance: 10, min: 1, max: 1 }] },
  { name: "Goblin Bruxo", description: "O chefe goblin que comanda a floresta com magia negra. Derrotá-lo concede recompensas em dobro.", level: 4, hp: 130, mana: 30, attack: 16, defense: 7, magic: 9, magicDefense: 6, speed: 10, xpReward: 200, classXpReward: 150, goldReward: 80, attackSpeed: 1500, isBoss: true, skills: JSON.stringify([
  ...
  { name: "Golem de Pedra", description: "Uma criatura colossal de rocha que guarda a entrada da Caverna do Dragão. Sua pele é quase impenetrável.", level: 8, hp: 400, mana: 20, attack: 28, defense: 18, magic: 4, magicDefense: 12, speed: 6, xpReward: 800, classXpReward: 600, goldReward: 300, attackSpeed: 2000, isElite: true, skills: JSON.stringify([
  ...
  ]), drops: [{ item: "Cota de Malha", chance: 20, min: 1, max: 1 }, { item: "Poção de Vida", chance: 60, min: 2, max: 4 }, { item: "Manto de Veludo", chance: 100, min: 1, max: 2, guaranteed: true }] },
  { name: "Dragão Sombrio", description: "O temido Dragão Sombrio, senhor da Caverna do Dragão. Derrotá-lo é a maior honra de um aventureiro.", level: 12, hp: 1500, mana: 100, attack: 45, defense: 25, magic: 30, magicDefense: 22, speed: 12, xpReward: 5000, classXpReward: 4000, goldReward: 2000, attackSpeed: 1400, isBoss: true, skills: JSON.stringify([
  ...
  ]), drops: [{ item: "Machado de Batalha", chance: 30, min: 1, max: 1 }, { item: "Cajado Arcano", chance: 30, min: 1, max: 1 }, { item: "Poção de Vida", chance: 100, min: 3, max: 5 }, { item: "Manto de Veludo", chance: 100, min: 4, max: 6, guaranteed: true }] },
];
...
const craftRecipes = [
  {
    ...
    resultQuantity: 1,
    requiredLevel: 2,
    ingredients: [{ itemName: "Espada de Iniciante", quantity: 2 }],
  },
  {
  ...
  },
  {
    ...
    resultQuantity: 1,
    requiredLevel: 3,
    ingredients: [{ itemName: "Cajado do Aprendiz", quantity: 3 }],
  },
  {
...
const classSkills = [
  {
    class: "cavaleiro",
    skills: [
      { name: "Ataque do Cavaleiro", slug: "ataque-do-cavaleiro", description: "Golpeia o inimigo com a espada. Usado automaticamente.", kind: "attack", trigger: "auto", target: "enemy", cooldown: 2000, manaCost: 0, rankRequired: 1, sortOrder: 1, icon: "/iconskill/Barbarian_1.png", actions: [{ action: "damage", amount: 6, scaling: [{ stat: "attack", factor: 1 }], damageType: "physical" }] },
      { name: "Golpe de Escudo", slug: "golpe-de-escudo", description: "Golpeia o inimigo com o escudo, causando dano físico e erguendo uma barreira.", kind: "attack", trigger: "active", target: "enemy", cooldown: 3000, manaCost: 8, rankRequired: 1, sortOrder: 2, icon: "/iconskill/Barbarian_2.png", iconSecondary: "/iconskill/secondaryicon/Sigil Spell/No_BG - Powers Sigil spell_00001__00001_.png", actions: [{ action: "damage", amount: 10, scaling: [{ stat: "attack", factor: 0.8 }], damageType: "physical" }, { action: "applyEffect", effect: "armadura-arcana", target: "self", stacks: 1 }] },
      { name: "Postura Defensiva", slug: "postura-defensiva", description: "Ergue uma barreira arcana que aumenta sua defesa.", kind: "buff", trigger: "active", target: "self", cooldown: 10000, manaCost: 10, rankRequired: 3, sortOrder: 3, icon: "/iconskill/Barbarian_3.png", iconSecondary: "/iconskill/secondaryicon/Sigil Spell/No_BG - Powers Sigil spell_00002__00001_.png", actions: [{ action: "applyEffect", effect: "armadura-arcana", target: "self", stacks: 2 }] },
      { name: "Grito de Guerra", slug: "grito-de-guerra", description: "Berro de batalha que aumenta seu ataque.", kind: "buff", trigger: "active", target: "self", cooldown: 15000, manaCost: 12, rankRequired: 4, sortOrder: 4, icon: "/iconskill/Barbarian_4.png", iconSecondary: "/iconskill/secondaryicon/Sigil Spell/No_BG - Powers Sigil spell_00003__00001_.png", actions: [{ action: "applyEffect", effect: "furia-do-guerreiro", target: "self", stacks: 2 }] },
      { name: "Juízo Final", slug: "juizo-final", description: "Um golpe devastador que abala a terra.", kind: "attack", trigger: "ultimate", target: "enemy", cooldown: 30000, manaCost: 25, rankRequired: 5, sortOrder: 5, icon: "/iconskill/Barbarian_5.png", actions: [{ action: "damage", amount: 40, scaling: [{ stat: "attack", factor: 1.5 }], damageType: "physical" }] },
    ],
    passives: [
  ...
  },
  {
    class: "mago",
    skills: [
      { name: "Rajada Arcana", slug: "rajada-arcana", description: "Dispara um projétil de mana. Usado automaticamente.", kind: "attack", trigger: "auto", target: "enemy", cooldown: 2000, manaCost: 0, rankRequired: 1, sortOrder: 1, icon: "/iconskill/FireMage_1.png", actions: [{ action: "damage", amount: 8, scaling: [{ stat: "magic", factor: 0.9 }], damageType: "magic" }] },
      { name: "Bola de Fogo", slug: "bola-de-fogo", description: "Lança uma esfera de fogo que causa dano mágico e queima o alvo.", kind: "attack", trigger: "active", target: "enemy", cooldown: 4000, manaCost: 15, rankRequired: 1, sortOrder: 2, icon: "/iconskill/FireMage_2.png", iconSecondary: "/iconskill/secondaryicon/Fireball/No_BG - Powers Fireball_00001__00001_.png", actions: [{ action: "damage", amount: 16, scaling: [{ stat: "magic", factor: 1.2 }], damageType: "magic" }, { action: "applyEffect", effect: "chama-arcana", target: "enemy", stacks: 1 }] },
      { name: "Foco Arcano", slug: "foco-arcano", description: "Concentra energia arcana, aumentando a recuperação de mana.", kind: "buff", trigger: "active", target: "self", cooldown: 12000, manaCost: 10, rankRequired: 3, sortOrder: 3, icon: "/iconskill/FireMage_3.png", iconSecondary: "/iconskill/secondaryicon/Fireball/No_BG - Powers Fireball_00002__00001_.png", actions: [{ action: "applyEffect", effect: "foco-arcano", target: "self", stacks: 2 }] },
      { name: "Raio Arcano", slug: "raio-arcano", description: "Um raio de energia pura que queima o alvo.", kind: "attack", trigger: "active", target: "enemy", cooldown: 9000, manaCost: 20, rankRequired: 4, sortOrder: 4, icon: "/iconskill/FireMage_4.png", iconSecondary: "/iconskill/secondaryicon/Fireball/No_BG - Powers Fireball_00003__00001_.png", actions: [{ action: "damage", amount: 22, scaling: [{ stat: "magic", factor: 1.5 }], damageType: "magic" }, { action: "applyEffect", effect: "chama-arcana", target: "enemy", stacks: 1 }] },
      { name: "Meteoro", slug: "meteoro", description: "Invoca um meteoro que esmaga os inimigos.", kind: "attack", trigger: "ultimate", target: "enemy", cooldown: 30000, manaCost: 30, rankRequired: 5, sortOrder: 5, icon: "/iconskill/FireMage_5.png", actions: [{ action: "damage", amount: 50, scaling: [{ stat: "magic", factor: 1.8 }], damageType: "magic" }] },
    ],
    passives: [
  ...
  },
  {
    class: "assassino",
    skills: [
      { name: "Corte Rápido", slug: "corte-rapido", description: "Um corte veloz com as lâminas. Usado automaticamente.", kind: "attack", trigger: "auto", target: "enemy", cooldown: 2000, manaCost: 0, rankRequired: 1, sortOrder: 1, icon: "/iconskill/Hunter_1.png", actions: [{ action: "damage", amount: 7, scaling: [{ stat: "attack", factor: 1 }], damageType: "physical" }] },
      { name: "Golpe Sombrio", slug: "golpe-sombrio", description: "Um ataque rápido vindo das sombras que causa sangramento.", kind: "attack", trigger: "active", target: "enemy", cooldown: 3500, manaCost: 10, rankRequired: 1, sortOrder: 2, icon: "/iconskill/Hunter_2.png", iconSecondary: "/iconskill/secondaryicon/Curse Spell/No_BG - Powers Curse spell_00001__00001_.png", actions: [{ action: "damage", amount: 12, scaling: [{ stat: "attack", factor: 1.1 }], damageType: "physical" }, { action: "applyEffect", effect: "sangramento", target: "enemy", stacks: 1 }] },
      { name: "Passo Sombrio", slug: "passo-sombrio", description: "Desliza entre as sombras, aumentando sua esquiva.", kind: "buff", trigger: "active", target: "self", cooldown: 12000, manaCost: 8, rankRequired: 3, sortOrder: 3, icon: "/iconskill/Hunter_3.png", iconSecondary: "/iconskill/secondaryicon/Curse Spell/No_BG - Powers Curse spell_00002__00001_.png", actions: [{ action: "applyEffect", effect: "passo-das-sombras", target: "self", stacks: 2 }] },
      { name: "Lâmina Envenenada", slug: "lamina-envenenada", description: "Envenena as lâminas e fere o alvo com veneno corrosivo.", kind: "attack", trigger: "active", target: "enemy", cooldown: 8000, manaCost: 14, rankRequired: 4, sortOrder: 4, icon: "/iconskill/Hunter_4.png", iconSecondary: "/iconskill/secondaryicon/Curse Spell/No_BG - Powers Curse spell_00003__00001_.png", actions: [{ action: "damage", amount: 15, scaling: [{ stat: "attack", factor: 1.3 }], damageType: "physical" }, { action: "applyEffect", effect: "veneno-corrosivo", target: "enemy", stacks: 1 }] },
      { name: "Execução", slug: "execucao", description: "Um golpe mortal que termina inimigos feridos.", kind: "attack", trigger: "ultimate", target: "enemy", cooldown: 25000, manaCost: 20, rankRequired: 5, sortOrder: 5, icon: "/iconskill/Hunter_5.png", actions: [{ action: "damage", amount: 45, scaling: [{ stat: "attack", factor: 1.6 }], damageType: "physical" }] },
    ],
    passives: [
  ...
  },
  {
    class: "suporte",
    skills: [
      { name: "Luz Sagrada", slug: "luz-sagrada", description: "Dispara um feixe de luz que fere o inimigo. Usado automaticamente.", kind: "attack", trigger: "auto", target: "enemy", cooldown: 2000, manaCost: 0, rankRequired: 1, sortOrder: 1, icon: "/iconskill/Monk_1.png", actions: [{ action: "damage", amount: 7, scaling: [{ stat: "magic", factor: 0.7 }], damageType: "magic" }] },
      { name: "Toque Curativo", slug: "toque-curativo", description: "Cura com luz divina.", kind: "heal", trigger: "active", target: "self", cooldown: 4000, manaCost: 12, rankRequired: 1, sortOrder: 2, icon: "/iconskill/Monk_2.png", actions: [{ action: "heal", amount: 25, scaling: [{ stat: "magic", factor: 0.9 }] }] },
      { name: "Palavra de Poder", slug: "palavra-de-poder", description: "Encanta a si mesmo, aumentando seu ataque.", kind: "buff", trigger: "active", target: "self", cooldown: 10000, manaCost: 10, rankRequired: 3, sortOrder: 3, icon: "/iconskill/Monk_3.png", iconSecondary: "/iconskill/secondaryicon/Holy Spell/No_BG - Powers holy spell_00004__00001_.png", actions: [{ action: "applyEffect", effect: "furia-do-guerreiro", target: "self", stacks: 2 }] },
      { name: "Bênção da Luz", slug: "bencao-da-luz", description: "Abençoa a si mesmo, regenerando vida ao longo do tempo.", kind: "buff", trigger: "active", target: "self", cooldown: 15000, manaCost: 15, rankRequired: 4, sortOrder: 4, icon: "/iconskill/Monk_4.png", iconSecondary: "/iconskill/secondaryicon/Holy Spell/No_BG - Powers holy spell_00005__00001_.png", actions: [{ action: "applyEffect", effect: "bencao-da-luz", target: "self", stacks: 1 }] },
      { name: "Milagre", slug: "milagre", description: "Uma cura massiva que restaura grande parte da vida.", kind: "heal", trigger: "ultimate", target: "self", cooldown: 30000, manaCost: 30, rankRequired: 5, sortOrder: 5, icon: "/iconskill/Monk_5.png", actions: [{ action: "heal", amount: 80, scaling: [{ stat: "magic", factor: 1.5 }] }] },
    ],
    passives: [
  ...
  },
  {
    ...
    skills: [
      { name: "Corte Sombrio", slug: "corte-sombrio", description: "Um corte veloz tingido de sombras. Usado automaticamente.", kind: "attack", trigger: "auto", target: "enemy", cooldown: 2000, manaCost: 0, rankRequired: 1, sortOrder: 1, icon: "/iconskill/Necromancer_1.png", actions: [{ action: "damage", amount: 8, scaling: [{ stat: "attack", factor: 1.05 }], damageType: "physical" }] },
      { name: "Lâmina da Penumbra", slug: "lamina-da-penumbra", description: "Fere o inimigo com uma lâmina sombria que causa sangramento.", kind: "attack", trigger: "active", target: "enemy", cooldown: 3500, manaCost: 10, rankRequired: 1, sortOrder: 2, icon: "/iconskill/Necromancer_2.png", iconSecondary: "/iconskill/secondaryicon/Void Skull/No_BG - Powers SkullDark Void_00001__00001_.png", actions: [{ action: "damage", amount: 13, scaling: [{ stat: "attack", factor: 1.15 }], damageType: "physical" }, { action: "applyEffect", effect: "sangramento", target: "enemy", stacks: 1 }] },
      { name: "Manto Sombrio", slug: "manto-sombrio", description: "Envolve-se em sombras, aumentando a esquiva e a defesa.", kind: "buff", trigger: "active", target: "self", cooldown: 12000, manaCost: 10, rankRequired: 3, sortOrder: 3, icon: "/iconskill/Necromancer_3.png", iconSecondary: "/iconskill/secondaryicon/Void Skull/No_BG - Powers SkullDark Void_00002__00001_.png", actions: [{ action: "applyEffect", effect: "passo-das-sombras", target: "self", stacks: 1 }, { action: "applyEffect", effect: "armadura-arcana", target: "self", stacks: 1 }] },
      { name: "Garra Corrosiva", slug: "garra-corrosiva", description: "Golpeia com garras envenenadas, causando veneno corrosivo.", kind: "attack", trigger: "active", target: "enemy", cooldown: 8000, manaCost: 14, rankRequired: 4, sortOrder: 4, icon: "/iconskill/Necromancer_4.png", iconSecondary: "/iconskill/secondaryicon/Void Skull/No_BG - Powers SkullDark Void_00003__00001_.png", actions: [{ action: "damage", amount: 16, scaling: [{ stat: "attack", factor: 1.35 }], damageType: "physical" }, { action: "applyEffect", effect: "veneno-corrosivo", target: "enemy", stacks: 1 }] },
      { name: "Tempestade das Sombras", slug: "tempestade-das-sombras", description: "Libera toda a escuridão acumulada em um golpe devastador.", kind: "attack", trigger: "ultimate", target: "enemy", cooldown: 30000, manaCost: 28, rankRequired: 5, sortOrder: 5, icon: "/iconskill/Necromancer_5.png", actions: [{ action: "damage", amount: 55, scaling: [{ stat: "attack", factor: 1.7 }], damageType: "physical" }, { action: "applyEffect", effect: "furia-do-guerreiro", target: "self", stacks: 2 }] },
    ],
    passives: [
...
const vipClasses = [
  {
    ...
    icon: "/classicon/senhor-das-sombras.png",
    element: "dark",
    rarity: "rare",
    difficulty: "medium",
    role: "tank",
...
async function seedWorld() {
  ...
  // Limpeza: anéis/colares são exclusivos do gacha (Booster). Desativa qualquer
  // Item do tipo ring/necklace que não esteja mais no seed e remove suas
  // referências de loja/drop (monstros são re-semeados logo abaixo).
  {
    ...
    if (staleIds.length > 0) {
      ...
      await prisma.dropItem.deleteMany({ where: { itemId: { in: staleIds } } });
      await prisma.item.updateMany({ where: { id: { in: staleIds } }, data: { isActive: false } });
      console.log("  disabled stale ring/necklace items:", staleIds.length);
    }
  }
