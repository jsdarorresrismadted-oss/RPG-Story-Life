...
const classSkills = [
  {
    ...
    skills: [
      ...
      { name: "Grito de Guerra", slug: "grito-de-guerra", description: "Berro de batalha que aumenta seu ataque.", kind: "buff", trigger: "active", target: "self", cooldown: 15000, manaCost: 12, rankRequired: 5, sortOrder: 4, icon: "/iconskill/Barbarian_4.png", iconSecondary: "/iconskill/secondaryicon/Sigil Spell/No_BG - Powers Sigil spell_00003__00001_.png", actions: [{ action: "applyEffect", effect: "furia-do-guerreiro", target: "self", stacks: 2 }] },
      { name: "Juízo Final", slug: "juizo-final", description: "Um golpe devastador que abala a terra.", kind: "attack", trigger: "ultimate", target: "enemy", cooldown: 30000, manaCost: 25, rankRequired: 8, sortOrder: 5, icon: "/iconskill/Barbarian_5.png", actions: [{ action: "damage", amount: 40, scaling: [{ stat: "attack", factor: 1.5 }], damageType: "physical" }] },
    ],
    passives: [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Raio Arcano", slug: "raio-arcano", description: "Um raio de energia pura que queima o alvo.", kind: "attack", trigger: "active", target: "enemy", cooldown: 9000, manaCost: 20, rankRequired: 5, sortOrder: 4, icon: "/iconskill/FireMage_4.png", iconSecondary: "/iconskill/secondaryicon/Fireball/No_BG - Powers Fireball_00003__00001_.png", actions: [{ action: "damage", amount: 22, scaling: [{ stat: "magic", factor: 1.5 }], damageType: "magic" }, { action: "applyEffect", effect: "chama-arcana", target: "enemy", stacks: 1 }] },
      { name: "Meteoro", slug: "meteoro", description: "Invoca um meteoro que esmaga os inimigos.", kind: "attack", trigger: "ultimate", target: "enemy", cooldown: 30000, manaCost: 30, rankRequired: 8, sortOrder: 5, icon: "/iconskill/FireMage_5.png", actions: [{ action: "damage", amount: 50, scaling: [{ stat: "magic", factor: 1.8 }], damageType: "magic" }] },
    ],
    passives: [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Lâmina Envenenada", slug: "lamina-envenenada", description: "Envenena as lâminas e fere o alvo com veneno corrosivo.", kind: "attack", trigger: "active", target: "enemy", cooldown: 8000, manaCost: 14, rankRequired: 5, sortOrder: 4, icon: "/iconskill/Hunter_4.png", iconSecondary: "/iconskill/secondaryicon/Curse Spell/No_BG - Powers Curse spell_00003__00001_.png", actions: [{ action: "damage", amount: 15, scaling: [{ stat: "attack", factor: 1.3 }], damageType: "physical" }, { action: "applyEffect", effect: "veneno-corrosivo", target: "enemy", stacks: 1 }] },
      { name: "Execução", slug: "execucao", description: "Um golpe mortal que termina inimigos feridos.", kind: "attack", trigger: "ultimate", target: "enemy", cooldown: 25000, manaCost: 20, rankRequired: 8, sortOrder: 5, icon: "/iconskill/Hunter_5.png", actions: [{ action: "damage", amount: 45, scaling: [{ stat: "attack", factor: 1.6 }], damageType: "physical" }] },
    ],
    passives: [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Bênção da Luz", slug: "bencao-da-luz", description: "Abençoa a si mesmo, regenerando vida ao longo do tempo.", kind: "buff", trigger: "active", target: "self", cooldown: 15000, manaCost: 15, rankRequired: 5, sortOrder: 4, icon: "/iconskill/Monk_4.png", iconSecondary: "/iconskill/secondaryicon/Holy Spell/No_BG - Powers holy spell_00005__00001_.png", actions: [{ action: "applyEffect", effect: "bencao-da-luz", target: "self", stacks: 1 }] },
      { name: "Milagre", slug: "milagre", description: "Uma cura massiva que restaura grande parte da vida.", kind: "heal", trigger: "ultimate", target: "self", cooldown: 30000, manaCost: 30, rankRequired: 8, sortOrder: 5, icon: "/iconskill/Monk_5.png", actions: [{ action: "heal", amount: 80, scaling: [{ stat: "magic", factor: 1.5 }] }] },
    ],
    passives: [
