  ...
  fields: [
    {
      ...
      required: true,
      optionsFrom: "items",
      optionsParams: { craftSelect: "true" },
      group: "Resultado do Craft",
      hint: "Itens que NÃO dropam de mobs, NÃO estão em lojas e NÃO estão em outros crafts. Quest items aparecem num grupo separado (também usáveis no craft). O nome do craft será o nome deste item.",
    },
    ...
    },
    {
      ...
      jsonSchema: {
        ...
        fields: [
          { name: "itemName", label: "Item (ingrediente)", type: "item-select", itemParams: { craftSelect: "true" } },
          { name: "quantity", label: "Quantidade", type: "number" },
        ],
      },
      hint: "Itens que NÃO dropam de mobs, NÃO estão em lojas e NÃO estão em outros crafts. Quest items aparecem num grupo separado (também usáveis no craft). Materiais e Equipamentos agrupados.",
    },
