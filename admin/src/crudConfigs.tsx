...
export const crudConfigs: CrudConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "itemId", label: "Item (tipo item)", type: "select", optionsFrom: "items", optionsParams: { forShop: "true" }, visibleIf: { field: "type", values: ["item"] } },
    ...
    fields: [
      {
        ...
        hint: "Apenas itens que NÃO dropam de mobs, NÃO estão em lojas e NÃO estão em quests. O nome do craft será o nome deste item.",
      },
      ...
      },
      {
        ...
        hint: "Itens que NÃO dropam de mobs, NÃO estão em lojas e NÃO estão em quests. Materiais e Equipamentos aparecem em grupos separados.",
      },
